.runAIREMLgaussianPCGcopy <- function(Y, X, start, covMatList, group.idx, AIREML.tol, drop.zeros, max.iter, verbose, Method = "EST"){
    # initial values
    startt <- Sys.time()
    m <- length(covMatList)
    #print(m)
    ...
    print("reach the end of runAIREMLgaussianPCG")
