...
KINGmat <- kingToMatrix(file.king = c(system.file("extdata", "MXL_ASW.kin0", package="GENESIS"), 
...
```{r}
# run PC-Relate
mypcrelate <- pcrelate(HapMap_genoData, pcMat = mypcair$vectors[,1:2], 
