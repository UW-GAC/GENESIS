...
nullmod <- fitNullModel(scanAnnot, outcome = "pheno", covars = "pc1", cov.mat = myGRM, 
                        family = gaussian)
```
...
```{r, eval=FALSE}
nullmod <- fitNullModel(scanAnnot, outcome = "pheno", covars = c("pc1","pc2","sex","age"), 
...
nullmod <- fitNullModel(scanAnnot, outcome = "pheno", covars = "pc1"
                        cov.mat = list("GRM" = myGRM, "House" = H), family = gaussian)
```
